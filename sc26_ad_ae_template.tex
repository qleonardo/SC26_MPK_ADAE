...
\end{center}
The matrix name is automatically extracted from the file path. Separate scripts are provided for CPU and GPU. To reproduce the full results, obtain all 110 matrices from SuiteSparse and replace the matrix list in \texttt{run.sh}.
