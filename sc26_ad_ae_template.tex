...
Download the 110 SuiteSparse matrices with $\text{nnz} \ge 8\times 10^6$ from \url{https://sparse.tamu.edu/} in Matrix Market (\texttt{.mtx}) format. Organize as \texttt{matrix/<name>/<name>.mtx}. For quick verification of the 7 representative matrices, use \texttt{python download\_matrices.py}.
